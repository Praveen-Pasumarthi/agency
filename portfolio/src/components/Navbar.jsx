      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="#contact"
              className="px-5 py-2.5 bg-brand text-white text-sm font-semibold rounded-full hover:bg-brand-dark transition-all"
            >
              Get a Quote
            </a>
            <button
          ...
          >
            <div className="px-4 py-4 space-y-1">
              ...
              <a
                href="#contact"
                onClick={() => setMobileOpen(false)}
                className="block px-4 py-3 bg-brand text-white text-sm font-semibold rounded-lg text-center"
              >
                Get a Quote
              </a>
            </div>
