      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <a href="#home" className="flex items-center gap-2">
            <Dumbbell className="text-brand" size={28} />
            <span className={`font-[family-name:var(--font-heading)] text-3xl tracking-wider transition-colors ${
              scrolled
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className={`text-sm font-semibold tracking-wider uppercase transition-colors hover:text-brand ${
                  scrolled
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className={`md:hidden overflow-hidden ${dark ? 'bg-gray-900/98' : 'bg-white/98'} backdrop-blur-md`}
          >
