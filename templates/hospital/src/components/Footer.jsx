      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a href={link.href} className="text-sm text-gray-500 hover:text-brand transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div className="lg:col-span-2">
            <h4 className="font-bold text-gray-900 mb-4 text-sm uppercase tracking-wider">Departments</h4>
            <ul className="space-y-2.5">
              {deptLinks.map((dept) => (
                <li key={dept}>
                  <a href="#departments" className="text-sm text-gray-500 hover:text-brand transition-colors">
                    {dept}
                  </a>
                </li>
              ))}
          ...
          {/* Emergency */}
          <div className="lg:col-span-2">
            <h4 className="font-bold text-gray-900 mb-4 text-sm uppercase tracking-wider">Emergency</h4>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="w-9 h-9 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-brand hover:border-brand/30 transition-all"
