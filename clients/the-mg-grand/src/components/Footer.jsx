    ...
    <footer className="bg-gray-900 dark:bg-black text-gray-400 pt-20 pb-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed">
              Madanapalle&apos;s largest premium multicuisine restaurant. Authentic biryani, tandoori specialties, and flavorful delicacies crafted with passion.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <a href="https://www.instagram.com/the_mg_grand_restaurant/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand hover:text-white transition-all" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/100046554450789/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand hover:text-white transition-all" aria-label="Facebook">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} The MG Grand. All rights reserved.
          </p>
