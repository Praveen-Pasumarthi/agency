...
Use this file to track all prospects, leads, and active clients.
...
- **Demo Sent** - Personalized demo/shared
- **Negotiating** - Discussing price/requirements
- **Won** - Client confirmed, 50% advance collected
- **Delivered** - Website deployed
- **Completed** - Full payment received + testimonial collected

---

## Active Leads

> Last updated: July 25, 2026 - Testing email notifications
...
| 2 | AKSA Fitness Studio | Gym | Seethammadara, Vizag | Prospect | +91 96423 60376 | aksa-fitness-studio.business.site | Basic Google site | 4.9/5, 167 reviews. Top-rated. Basic Google site. |
...
| # | Business Name | Type | Quote | Advance Paid | Deadline | Status | Notes |
|---|--------------|------|-------|-------------|----------|--------|-------|
| 1 | | | | | | | |
| 2 | | | | | | | |
...
| # | Business Name | Type | Final Price | Testimonial | Maintenance | Notes |
|---|--------------|------|-------------|-------------|-------------|-------|
| 1 | | | | | | |
